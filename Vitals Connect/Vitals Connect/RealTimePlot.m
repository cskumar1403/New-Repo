...
-(void)renderInView:(CPTGraphHostingView *)hostingView
{
    ...
    CPTMutableLineStyle *borderLine = [CPTLineStyle lineStyle];
    borderLine.lineColor = [CPTColor redColor];
    //graph.plotAreaFrame.borderLineStyle = borderLine;
    ...
    plotSpace.yRange = [CPTPlotRange plotRangeWithLocation:CPTDecimalFromUnsignedInteger(50) length:CPTDecimalFromUnsignedInteger(130)];
