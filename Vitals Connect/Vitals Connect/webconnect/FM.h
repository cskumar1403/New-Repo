...
+ (bool)toBooleanWithValue:(NSData*)value startIndex:(int)startIndex;
+ (double)toDoubleWithValue:(NSData*)value startIndex:(int)startIndex;
+ (float)toFloatWithValue:(NSData*)value startIndex:(int)startIndex;
+ (short)toShortWithValue:(NSData*)value startIndex:(int)startIndex;
+ (int)toIntegerWithValue:(NSData*)value startIndex:(int)startIndex;
+ (int)toIntegerFromShortWithValue:(NSData*)value startIndex:(int)startIndex;
+ (long long)toLongWithValue:(NSData*)value startIndex:(int)startIndex;
+ (long long)toLongFromIntegerWithValue:(NSData*)value startIndex:(int)startIndex;

+ (NSMutableData*)getBooleanBytesWithValue:(bool)value;
+ (NSMutableData*)getDoubleBytesWithValue:(double)value;
+ (NSMutableData*)getFloatBytesWithValue:(float)value;
...
+ (bool)toBooleanNetworkWithValue:(NSData*)value startIndex:(int)startIndex;
+ (double)toDoubleNetworkWithValue:(NSData*)value startIndex:(int)startIndex;
+ (float)toFloatNetworkWithValue:(NSData*)value startIndex:(int)startIndex;
+ (short)toShortNetworkWithValue:(NSData*)value startIndex:(int)startIndex;
+ (int)toIntegerNetworkWithValue:(NSData*)value startIndex:(int)startIndex;
+ (int)toIntegerFromShortNetworkWithValue:(NSData*)value startIndex:(int)startIndex;
+ (long long)toLongNetworkWithValue:(NSData*)value startIndex:(int)startIndex;
+ (long long)toLongFromIntegerNetworkWithValue:(NSData*)value startIndex:(int)startIndex;

+ (NSMutableData*)getBooleanBytesNetworkWithValue:(bool)value;
